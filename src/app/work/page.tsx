...
export const projects = [
  ...
  },
  {
    ...
    longDescription: "A high-precision, premium-designed web application that enables users to upload resumes in various formats for enhancement via the Gemini API. Features a responsive, glassmorphic UI with smooth animations and secure server-side processing.",
